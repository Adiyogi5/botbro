                        ...
                        <div class="col-12 card p-0">
                                <div class="d-flex align-items-center justify-content-center">
                                    <div
                                        ...
                                        <div class="my-auto">
                                            <h5 class="mb-0"><strong>Investment No.</strong> {{ $investment_data->invest_no }}</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="row gx-5 p-4">
                                    <div class="col border-end">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="px-1 rounded-1 {{ $investment_data->is_approved == 1 || $investment_data->is_approved == '1' ? 'bg-success' : 'bg-danger' }}">
                                                {{ $investment_data->is_approved == 1 || $investment_data->is_approved == '1' ? 'APPROVED' : 'NOT APPROVED' }}
                                            </span>      
                                        </div>                                        
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <span class="px-1 rounded-1 {{ $investment_data->payment_status == 1 ? 'bg-success' : 'bg-danger' }}">
                                                {{ $investment_data->payment_status == 1 ? 'PAID' : 'UNPAID' }}
                                            </span>
                                        </div>                                        
                                        <div class="d-flex align-items-center justify-content-between">
                                            <p class="fw-bold">Payment Screenshot : </p>
                                            <p><a href="{{ imageexist($investment_data->screenshot) }}" target="_blank"><img class="img-fluid border" src="{{ imageexist($investment_data->screenshot) }}" alt="" style="height: auto; width:160px"></a></p>
                                        </div>
                                    </div>
                                </div>
