            ...
            <div class="card">
              <div class="card-header d-flex justify-content-end">
                <div class="card-title pull-right">
                  <a href="{{ url('admin/states')}}" class="btn btn-success"><i class="fa fa-list"></i> State Lists</a>
                </div>
              </div>
              <form id="statesForm" method="post" action="{{ url('admin/states') }}">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" id="name" placeholder="Enter states name">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}" id="code" placeholder="Enter states code">
