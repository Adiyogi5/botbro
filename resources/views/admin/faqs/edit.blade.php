      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <form id="faqsForm" method="post" action="{{ url('admin/faqs', ['id' => $data->id]) }}">
              @method('PUT')
              @csrf
               <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <select name="faq_type_id" id="faq_type_id"class="form-control">
                            ...
                            <option value="{{$value->id}}" <?php if(old('faq_type_id',$data->faq_type_id)== $value['id']){ echo 'selected'; } ?> >{{$value->name}}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="question" class="form-control" value="{{ old('question',$data->question) }}" id="question" placeholder="Enter Faq Question">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <textarea id="answer" name="answer" class="form-control ckeditor" rows="4" id="answer">{{ old('answer',$data->answer) }} </textarea>  
