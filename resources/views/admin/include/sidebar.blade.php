...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset($site_settings['footer_logo']) }}" alt="{{ $site_settings['application_name'] }}"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                @if (Auth::guard('admin')->check())
                    <img src="{{ get_image(Auth::guard('admin')->user()->image, 'map') }}"
        ...
        @php
            ...
            $sidemenu = ['investments'];
            foreach ($sidemenu as $menukey => $menuvalue) {
                if (in_array($menuvalue, $fullpage)) {
                    $active11 = 'active';
                }
                if (in_array('investments', $fullpage)) {
                    $a1101 = 'active';
                }
            }
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar  flex-column" data-widget="treeview" role="menu"
                ...
                @if (userCan([103, 104, 105, 106, 107, 108, 109]))
                    <li class="nav-item {{ @$active2 }} {{ @$active2 ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if (userCan(108))
                                <li class="nav-item">
                                    <a href="{{ route('admin.reward_masters.index') }}"
                                        class="nav-link {{ @$a122 }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Reward Masters</p>
                                    </a>
                ...
                @if (userCan([112, 113]))
                    <li class="nav-item {{ @$active8 }} {{ @$active8 ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            @if (userCan(112))
                                <li class="nav-item">
                                    <a href="{{ route('admin.faq_types.index') }}"
                                        class="nav-link {{ @$a113 }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>FAQ Types </p>
                                    </a>
                ...
                @if (userCan([116]))
                    <li class="nav-item {{ @$active11 }} {{ @$active11 ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ @$active11 }}">
                            ...
                            <p>Investments <i class="fas fa-angle-left right"></i> </p>
                        </a>
                        <ul class="nav nav-treeview">
                            @if (userCan(116))
                                <li class="nav-item">
                                    <a href="{{ url('admin/investments') }}" class="nav-link {{ @$a1101 }}">
                                        <i class="far fa-circle nav-icon"></i>
                ...
                @if (userCan(125))
                    <li class="nav-item">
                        <a href="{{ route('admin.admin_notifications.index') }}"
                            class="nav-link {{ @$active14 }}">
