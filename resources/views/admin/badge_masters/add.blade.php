    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form id="badgeMasterForm" method="post" action="{{ route('admin.badge_masters.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" id="name" placeholder="Enter Badge name">
