        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form id="countriesForm" method="post" action="{{ url('admin/countries') }}">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="number" name="country_code" class="form-control" value="{{ old('country_code') }}" id="country_code" placeholder="Enter Country Code">
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="{{ old('name') }}" id="name" placeholder="Enter Country Name">
