                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-end">
                        <div class="card-title pull-right">
                            <a href="{{ route('admin.address.index', ['user_id' => $user->id]) }}" class="btn btn-success"><i class="fa fa-list"></i>
                                Coustomer Address List</a>
                        </div>
                    </div>
                    <form id="customerForm" method="post" action="{{ route('admin.address.store', ['user_id' => $user->id]) }}" enctype="multipart/form-data">
                        <div class="card-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="country" id="country" class="form-select form-control formtext-color">
                                        ...
                                        <option value="{{ $cv->id }}" {{ old('country', '') == $cv->id ? 'selected' : '' }}>
                                            {{ $cv->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="postcode" class="form-control" value="{{ old('postcode') }}" id="postcode" placeholder="Enter postcode">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address_1" class="form-control" id="address_1" placeholder="Enter address 1">{{ old('address_1') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address_2" class="form-control" id="address_2" placeholder="Enter address 2">{{ old('address_2') }}</textarea>
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.status == true) {
                    $('#state').html(result.data).trigger('change');
