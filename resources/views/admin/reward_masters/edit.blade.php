    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form id="rewardMasterForm" method="post" action="{{ route('admin.reward_masters.update', [$data->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $data->name) }}" id="name" placeholder="Enter Reward name">
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#rewardMasterForm").validate({
      ...
      messages: {
        name: {
          required: "Please enter reward master name",
        },
        min_products: {
