        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form id="productsForm" method="POST" action="{{ route('admin.products.update', [$product->id]) }}" enctype='multipart/form-data'>
                        @csrf
                        @method('PUT')
                        <nav class="mt-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{ old('name', $product->name) }}" id="name" placeholder="Enter Product Name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="model" class="form-control" value="{{ old('model', $product->model) }}" id="model" placeholder="Enter Product Model">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" class="form-control" value="{{ old('price', $product->price) }}" id="price" placeholder="Enter Product Price">
                                                <label class="error">{{ $errors->first('price') }}</label>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <label for="product_image">Image <small class="text-success"> ( Image Size must be 250px x 250px )</small></label>
                                            <input type="file" name="product_image" class="form-control" id="product_image">
                                            
                                            <?php if(!empty($product->image)): ?>
                                                <p><img class="img-fluid border border-dark p-1 rounded ms-2" style="width: 80px;height: 80px;margin-top:6px;" src="{{ imageexist($product['old_product_image']??($product->image??''), 'products') }}"></p>
                                            <?php endif; ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="stock_quantity" class="form-control" value="{{ old('stock_quantity', $product->stock) }}" id="stock_quantity" placeholder="Enter Sort Order">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', $product->sort_order) }}" id="sort_order" placeholder="Enter Sort Order">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="referral_price" class="form-control" value="{{ old('referral_price', $product->referral_price) }}" id="referral_price" placeholder="Enter From Referral Amount"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/[^\d\.]/g, '')" >
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="refer_price" class="form-control" value="{{ old('refer_price', $product->refer_price) }}" id="refer_price" placeholder="Enter To Referral Amount "  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/[^\d\.]/g, '')" >
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="form-control" id="description" rows="4" placeholder="Enter Product description">{{ old('description', $product->description) }}</textarea>
                                                                ...
                                                                <div class="col-md-12 px-0" id="objectives">
                                                                    <table class="table table-bordered" id="product_image_id">
                                                                        ...
                                                                        <tbody id="{{ $media_key }}">
                                                                            ...
                                                                            $product_medias = old($media_key);
                                                                            } else {
                                                                            $product_medias = $product->product_image;
                                                                            }
                                                                            @endphp

                                                                            @if(!empty($product_medias))
                                                                            @foreach($product_medias as $key => $media)
                                                                            @php $lang_id = $key; @endphp
                                                                            <tr id="path-row{{ $media_key.'_'.$key }}">
                                                                                <td class="form-group mb-0">
                                                                                    <a href="{{ get_image($media['old_media']??($media['attachment']??''), 'product_detail') }}" target="_blank">
                                                                                        <img class="img-fluid border border-dark p-1 rounded-circle" style="width: 40px;height: 40px;" src="{{ get_image($media['old_media']??($media->attachment??''), 'product_detail') }}">
                                                                                        <input type="hidden" name="{{ $media_key }}[{{ $key }}][old_media]" value="{{ $media['old_media']??($media->attachment??Null) }}" />
                                                                                    </a>
                                                                                ...
                                                                                <td class="form-group mb-0">
                                                                                    <input type="number" name="{{ $media_key }}[{{ $key }}][sort_order]" class="form-control text_content" value="{{ $media['sort_order'] }}" />
                                    ...
                                    <div class="" style="margin-top:3px;">
                                        ...
                                        if (count($product->productCategory) > 0) {
                                            foreach ($product->productCategory as $key => $value) {
                                                $category_id = $value['category_id'] . ',' . $category_id;
                                                $category_list .= '<div class="col-md-12 related_' . $value['category_id'] . '">';
                                                $category_list .= $value->category->name;
                                                $category_list .= '<button type="button" class="btn py-0 px-1 align-baseline remove_related_category" rid="' . $value['category_id'] . '">
...
<script type="text/javascript">
    ...
    var validator = $('#productsForm').validate({
        ...
        messages: {
            ...
            referral_price: {
                required: "Please select referral price",
                number: "Please enter Numeric value",
            },
            refer_price: {
                required: "Please select refer price",
                number: "Please enter Numeric value",
            },
            sort_order: {
