                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            ...
                            <div class="card-title pull-right">
                                <a href="{{ route('admin.customer.index') }}" class="btn btn-success"><i
                                        class="fa fa-list"></i> Customer Lists</a>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Badge Level</button>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-refers-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-refers" type="button" role="tab"
                                        aria-controls="pills-refers" aria-selected="false">Refers</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-investments-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-investments" type="button" role="tab"
                                        aria-controls="pills-investments" aria-selected="false">Investments</button>
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-wallet-tab" data-bs-toggle="pill" data-bs-target="#pills-wallet" type="button" role="tab" aria-controls="pills-wallet" aria-selected="false">Wallet</button>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-withdraw-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-withdraw" aria-selected="false">Investment Withdrawal</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-Referral-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-Referral" type="button" role="tab"
                                        aria-controls="pills-Referral" aria-selected="false">Referral Withdrawal</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-rewards-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-rewards" type="button" role="tab"
                                        aria-controls="pills-rewards" aria-selected="false">Reffer And Commission Ledger</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-address-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-address" type="button" role="tab"
                                        aria-controls="pills-address" aria-selected="false">Address</button>
                                </li>
                                {{-- <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-profile" role="tabpanel"
                                    ...
                                    <div class="row" style="line-height: 30px;">
                                        ...
                                        <div class="col-md-4"><b>Name:&nbsp; </b>
                                            <?= $data['name'] . ' ' . $data['lname'] ?></div>
                                        <div class="col-md-4"><b>Mobile:&nbsp; </b>
                                            <?= !empty($data['mobile']) ? $data['mobile'] : '--' ?></div>
                                        <div class="col-md-4"><b>Email:&nbsp; </b>
                                            <?= !empty($data['email']) ? $data['email'] : '--' ?></div>
                                        <div class="col-md-4"><b>Refer Code:&nbsp; </b>
                                            <?= isset($data['reffer_code']) ? $data['reffer_code'] : '' ?></div>
                                        <div class="col-md-4"><b>Membership Status:&nbsp; </b> <?php
                                        ...
                                        ?></div>
                                        <div class="col-md-4"><b>Register At:&nbsp; </b>
                                ...
                                <div class="tab-pane fade" id="pills-refers" role="tabpanel"
                                    aria-labelledby="pills-refers-tab">
                                    <table class="table table-bordered table-striped datatable_refer"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Refer Name</th>
                                ...
                                <div class="tab-pane fade" id="pills-investments" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped datatable_investments"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Invest No.</th>
                                ...
                                {{-- <div class="tab-pane fade" id="pills-wallet" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped datatable_wallet"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Voucher No.</th>
                                ...
                                <div class="tab-pane fade" id="pills-withdraw" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped datatable_withdraw"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Voucher No.</th>
                                ...
                                <div class="tab-pane fade" id="pills-Referral" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped datatable_Referral"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Voucher No.</th>
                                ...
                                <div class="tab-pane fade" id="pills-rewards" role="tabpanel"
                                    aria-labelledby="pills-rewards-tab">
                                    <table class="table table-bordered table-striped datatable_rewards"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                ...
                                <div class="tab-pane fade" id="pills-address" role="tabpanel"
                                    ...
                                    <table class="table table-bordered table-striped datatable_address"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                ...
                                {{-- <div class="tab-pane fade" id="pills-profit_sharing" role="tabpanel"
                                    aria-labelledby="pills-profit_sharing-tab">
                                    <table class="table table-bordered table-striped datatable_profit_sharing"
                                        style="width:100% !important">
                                        <thead>
                                            <tr>
                                                <th>Customer Name</th>
